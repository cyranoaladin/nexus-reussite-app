...
import { Users, Clock, BrainCircuit, Target, ArrowRight } from "lucide-react"
          ...
          <Card className="bg-white border-slate-200 shadow-xl">
            ...
            <CardContent className="space-y-8">
              ...
              <div className="bg-slate-50 rounded-xl p-6 text-center">
                <div className="mb-4">
                  <span className="text-3xl font-bold text-slate-900">850 TND</span>
                  <span className="text-slate-600 ml-2">(paiement unique)</span>
                </div>
